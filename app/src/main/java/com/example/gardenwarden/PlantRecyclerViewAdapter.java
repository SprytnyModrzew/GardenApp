...
public class PlantRecyclerViewAdapter extends RecyclerView.Adapter<PlantRecyclerViewAdapter.ViewHolder> {
    ...
    private final PlantFragment2.OnListFragmentInteractionListener mListener;

    PlantRecyclerViewAdapter(List<Plant> items, PlantFragment2.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
